...
**Final local build:** pending packaging after this verified source is committed. Visible native export acceptance, live replacement-Dock host/widget proof, successful packaged AppleScript replies, physical input/display/Space coverage and release signing/distribution remain open. No roadmap checkbox is closed by this checkpoint.
